...
namespace CLOCK2PAY
{
    public partial class TimeOutNotif : Form
    {
        ...
        {
            label1.Text = $"Welcome {firstname} {lastname} Your Time Out is now Recorded"; // Combine Firstname and Lastname
            label4.Text = "Position:  " + designation;
        }

        private void TimeOutNotif_Load(object sender, EventArgs e)
        {
