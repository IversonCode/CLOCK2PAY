...
namespace CLOCK2PAY
{
    public partial class TimeInNotif : Form
    {
        ...
        {
            label1.Text = $"Welcome {firstname} {lastname} Your Time In is now Recorded"; // Combine Firstname and Lastname
            label4.Text = "Position:  " + designation;
        }


        private void TimeInNotif_Load(object sender, EventArgs e)
        {
